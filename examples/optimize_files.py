...
try:
    ...
    files = (
            ...
            os.path.dirname(os.path.abspath(__file__)) + os.sep + 'images' + os.sep + '3.png',
            os.path.dirname(os.path.abspath(__file__)) + os.sep + 'images' + os.sep + '2323.png'
    )
    ...
    timeout = 300
    # Optimize the file
    r = api.optimize(files, params, timeout)
